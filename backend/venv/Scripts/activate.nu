...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\lunym\Repository\Python\backend\technical-challenge-v202109\backend\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\lunym\Repository\Python\backend\technical-challenge-v202109\backend\venv\Scripts\deactivate.nu'
